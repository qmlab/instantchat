...
g=e.extend({},C,g);g.buttons||(g.buttons={});g.backdrop=g.backdrop?"static":!1;d=g.buttons;k=a(d);b(d,function(b,a,g){e.isFunction(a)&&(a=d[b]={callback:a});if("object"!==e.type(a))throw Error("button with key "+b+" must be an object");a.label||(a.label=b);a.className||(a.className=2>=k&&g===k-1?"btn-primary":"btn-default")});return g}function k(b,a){var g=b.length,d={};if(1>g||2<g)throw Error("Invalid argument length");2===g||"string"===typeof b[0]?(d[a[0]]=b[0],d[a[1]]=b[1]):d=b[0];return d}function r(b,
a,g){return e.extend(!0,{},b,k(a,g))}function l(b,a,g,d){b={className:"bootbox-"+b,buttons:t.apply(null,a)};return z(r(b,d,g),a)}function t(){for(var b={},a=0,g=arguments.length;a<g;a++){var d=arguments[a],k=d.toLowerCase(),d=d.toUpperCase(),f=S[C.locale];b[k]={label:f?f[d]:S.en[d]}}return b}function z(a,g){var d={};b(g,function(b,a){d[a]=!0});b(a.buttons,function(b){if(d[b]===f)throw Error("button key "+b+" is not allowed (options are "+g.join("\n")+")");});return a}var J={text:"<input class='bootbox-input bootbox-input-text form-control' autocomplete=off type=text />",
textarea:"<textarea class='bootbox-input bootbox-input-textarea form-control'></textarea>",email:"<input class='bootbox-input bootbox-input-email form-control' autocomplete='off' type='email' />",select:"<select class='bootbox-input bootbox-input-select form-control'></select>",checkbox:"<div class='checkbox'><label><input class='bootbox-input bootbox-input-checkbox' type='checkbox' /></label></div>",date:"<input class='bootbox-input bootbox-input-date form-control' autocomplete=off type='date' />",
time:"<input class='bootbox-input bootbox-input-time form-control' autocomplete=off type='time' />",number:"<input class='bootbox-input bootbox-input-number form-control' autocomplete=off type='number' />",password:"<input class='bootbox-input bootbox-input-password form-control' autocomplete='off' type='password' />"},C={locale:"en",backdrop:!0,animate:!0,className:null,closeButton:!0,show:!0,container:"body"},n={alert:function(){var b;b=l("alert",["ok"],["message","callback"],arguments);if(b.callback&&
!e.isFunction(b.callback))throw Error("alert requires callback property to be a function when provided");b.buttons.ok.callback=b.onEscape=function(){return e.isFunction(b.callback)?b.callback():!0};return n.dialog(b)},confirm:function(){var b;b=l("confirm",["cancel","confirm"],["message","callback"],arguments);b.buttons.cancel.callback=b.onEscape=function(){return b.callback(!1)};b.buttons.confirm.callback=function(){return b.callback(!0)};if(!e.isFunction(b.callback))throw Error("confirm requires a callback");
return n.dialog(b)},prompt:function(){var a,g,d,k,l,v;k=e("<form class='bootbox-form'></form>");g={className:"bootbox-prompt",buttons:t("cancel","confirm"),value:"",inputType:"text"};a=z(r(g,arguments,["title","callback"]),["cancel","confirm"]);g=a.show===f?!0:a.show;a.message=k;a.buttons.cancel.callback=a.onEscape=function(){return a.callback(null)};a.buttons.confirm.callback=function(){var g;switch(a.inputType){case "text":case "textarea":case "email":case "select":case "date":case "time":case "number":case "password":g=
l.val();break;case "checkbox":var d=l.find("input:checked");g=[];b(d,function(b,a){g.push(e(a).val())})}return a.callback(g)};a.show=!1;if(!a.title)throw Error("prompt requires a title");if(!e.isFunction(a.callback))throw Error("prompt requires a callback");if(!J[a.inputType])throw Error("invalid prompt type");l=e(J[a.inputType]);switch(a.inputType){case "text":case "textarea":case "email":case "date":case "time":case "number":case "password":l.val(a.value);break;case "select":var L={};v=a.inputOptions||
[];if(!v.length)throw Error("prompt with select requires options");b(v,function(b,a){var g=l;if(a.value===f||a.text===f)throw Error("given options in wrong format");a.group&&(L[a.group]||(L[a.group]=e("<optgroup/>").attr("label",a.group)),g=L[a.group]);g.append("<option value='"+a.value+"'>"+a.text+"</option>")});b(L,function(b,a){l.append(a)});l.val(a.value);break;case "checkbox":var C=e.isArray(a.value)?a.value:[a.value];v=a.inputOptions||[];if(!v.length)throw Error("prompt with checkbox requires options");
if(!v[0].value||!v[0].text)throw Error("given options in wrong format");l=e("<div/>");b(v,function(g,d){var k=e(J[a.inputType]);k.find("input").attr("value",d.value);k.find("label").append(d.text);b(C,function(b,a){a===d.value&&k.find("input").prop("checked",!0)});l.append(k)})}a.placeholder&&l.attr("placeholder",a.placeholder);a.pattern&&l.attr("pattern",a.pattern);k.append(l);k.on("submit",function(b){b.preventDefault();b.stopPropagation();d.find(".btn-primary").click()});d=n.dialog(a);d.off("shown.bs.modal");
d.on("shown.bs.modal",function(){l.focus()});!0===g&&d.modal("show");return d},dialog:function(a){a=g(a);var k=e("<div class='bootbox modal' tabindex='-1' role='dialog'><div class='modal-dialog'><div class='modal-content'><div class='modal-body'><div class='bootbox-body'></div></div></div></div></div>"),f=k.find(".modal-dialog"),r=k.find(".modal-body"),l="",t={onEscape:a.onEscape};b(a.buttons,function(b,a){l+="<button data-bb-handler='"+b+"' type='button' class='btn "+a.className+"'>"+a.label+"</button>";
t[b]=a.callback});r.find(".bootbox-body").html(a.message);!0===a.animate&&k.addClass("fade");a.className&&k.addClass(a.className);"large"===a.size&&f.addClass("modal-lg");"small"===a.size&&f.addClass("modal-sm");a.title&&r.before("<div class='modal-header'><h4 class='modal-title'></h4></div>");a.closeButton&&(f=e("<button type='button' class='bootbox-close-button close' data-dismiss='modal' aria-hidden='true'>&times;</button>"),a.title?k.find(".modal-header").prepend(f):f.css("margin-top","-10px").prependTo(r));
a.title&&k.find(".modal-title").html(a.title);l.length&&(r.after("<div class='modal-footer'></div>"),k.find(".modal-footer").html(l));k.on("hidden.bs.modal",function(b){b.target===this&&k.remove()});k.on("shown.bs.modal",function(){k.find(".btn-primary:first").focus()});k.on("escape.close.bb",function(b){t.onEscape&&d(b,k,t.onEscape)});k.on("click",".modal-footer button",function(b){var a=e(this).data("bb-handler");d(b,k,t[a])});k.on("click",".bootbox-close-button",function(b){d(b,k,t.onEscape)});
k.on("keyup",function(b){27===b.which&&k.trigger("escape.close.bb")});e(a.container).append(k);k.modal({backdrop:a.backdrop,keyboard:!1,show:!1});a.show&&k.modal("show");return k},setDefaults:function(){var b={};2===arguments.length?b[arguments[0]]=arguments[1]:b=arguments[0];e.extend(C,b)},hideAll:function(){e(".bootbox").modal("hide");return n}},S={br:{OK:"OK",CANCEL:"Cancelar",CONFIRM:"Sim"},cs:{OK:"OK",CANCEL:"Zru\u0161it",CONFIRM:"Potvrdit"},da:{OK:"OK",CANCEL:"Annuller",CONFIRM:"Accepter"},
...
function(){return this.sliding?void 0:this.slide("next")};f.prototype.prev=function(){return this.sliding?void 0:this.slide("prev")};f.prototype.slide=function(b,a){var d=this.$element.find(".item.active"),e=a||this.getItemForDirection(b,d),l=this.interval,t="next"==b?"left":"right",z="next"==b?"first":"last",J=this;if(!e.length){if(!this.options.wrap)return;e=this.$element.find(".item")[z]()}if(e.hasClass("active"))return this.sliding=!1;var z=e[0],C=c.Event("slide.bs.carousel",{relatedTarget:z,
direction:t});if(this.$element.trigger(C),!C.isDefaultPrevented()){if(this.sliding=!0,l&&this.pause(),this.$indicators.length)this.$indicators.find(".active").removeClass("active"),(C=c(this.$indicators.children()[this.getItemIndex(e)]))&&C.addClass("active");var n=c.Event("slid.bs.carousel",{relatedTarget:z,direction:t});return c.support.transition&&this.$element.hasClass("slide")?(e.addClass(b),e[0].offsetWidth,d.addClass(t),e.addClass(t),d.one("bsTransitionEnd",function(){e.removeClass([b,t].join(" ")).addClass("active");
d.removeClass(["active",t].join(" "));J.sliding=!1;setTimeout(function(){J.$element.trigger(n)},0)}).emulateTransitionEnd(f.TRANSITION_DURATION)):(d.removeClass("active"),e.addClass("active"),this.sliding=!1,this.$element.trigger(n)),l&&this.cycle(),this}};var d=c.fn.carousel;c.fn.carousel=e;c.fn.carousel.Constructor=f;c.fn.carousel.noConflict=function(){return c.fn.carousel=d,this};var a=function(b){var a,d=c(this),f=c(d.attr("data-target")||(a=d.attr("href"))&&a.replace(/.*(?=#[^\s]+$)/,""));f.hasClass("carousel")&&
...
this.type,this);this.options.container?d.appendTo(this.options.container):d.insertAfter(this.$element);var g=this.getPosition(),f=d[0].offsetWidth,l=d[0].offsetHeight;if(k){var k=a,t=this.options.container?c(this.options.container):this.$element.parent(),t=this.getPosition(t),a="bottom"==a&&g.bottom+l>t.bottom?"top":"top"==a&&g.top-l<t.top?"bottom":"right"==a&&g.right+f>t.width?"left":"left"==a&&g.left-f<t.left?"right":a;d.removeClass(k).addClass(a)}g=this.getCalculatedOffset(a,g,f,l);this.applyPlacement(g,
...
left:Math.round(a.left)})}},d),0);b.addClass("in");var l=b[0].offsetWidth,t=b[0].offsetHeight;"top"==a&&t!=f&&(d.top=d.top+f-t);var z=this.getViewportAdjustedDelta(a,d,l,t);z.left?d.left+=z.left:d.top+=z.top;g=(e=/top|bottom/.test(a))?2*z.left-g+l:2*z.top-f+t;f=e?"offsetWidth":"offsetHeight";b.offset(d);this.replaceArrow(g,b[0][f],e)};e.prototype.replaceArrow=function(d,a,b){this.arrow().css(b?"left":"top",50*(1-d/a)+"%").css(b?"top":"left","")};e.prototype.setContent=function(){var d=this.tip(),
...
t=c.Event("show.bs.tab",{relatedTarget:f[0]});(f.trigger(e),b.trigger(t),t.isDefaultPrevented()||e.isDefaultPrevented())||(d=c(d),this.activate(b.closest("li"),a),this.activate(d,d.parent(),function(){f.trigger({type:"hidden.bs.tab",relatedTarget:b[0]});b.trigger({type:"shown.bs.tab",relatedTarget:f[0]})}))}};f.prototype.activate=function(b,a,d){function e(){l.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1);
b.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0);t?(b[0].offsetWidth,b.addClass("in")):b.removeClass("fade");b.parent(".dropdown-menu")&&b.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0);d&&d()}var l=a.find("> .active"),t=d&&c.support.transition&&(l.length&&l.hasClass("fade")||!!a.find("> .fade").length);l.length&&t?l.one("bsTransitionEnd",e).emulateTransitionEnd(f.TRANSITION_DURATION):e();l.removeClass("in")};var d=c.fn.tab;
...
f.VERSION="3.3.1";f.RESET="affix affix-top affix-bottom";f.DEFAULTS={offset:0,target:window};f.prototype.getState=function(a,b,d,c){var f=this.$target.scrollTop(),e=this.$element.offset(),t=this.$target.height();if(null!=d&&"top"==this.affixed)return d>f?"top":!1;if("bottom"==this.affixed)return null!=d?f+this.unpin<=e.top?!1:"bottom":a-c>=f+t?!1:"bottom";var z=null==this.affixed,f=z?f:e.top;return null!=d&&d>=f?"top":null!=c&&f+(z?t:b)>=a-c?"bottom":!1};f.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;
...
r[b].apply(r,a)});return f};e.fn.bootstrapSwitch.Constructor=d;return e.fn.bootstrapSwitch.defaults={state:!0,size:null,animate:!0,disabled:!1,readonly:!1,indeterminate:!1,inverse:!1,radioAllOff:!1,onColor:"primary",offColor:"default",onText:"ON",offText:"OFF",labelText:"&nbsp;",handleWidth:"auto",labelWidth:"auto",baseClass:"bootstrap-switch",wrapperClass:"wrapper",onInit:function(){},onSwitchChange:function(){}}})(window.jQuery,window)}).call(this);$(function(){var c=$(window),e=$(".roomnameInput"),f=$("#publicMessages"),d=$(".users"),a=$(".inputMessage"),b=$(".privateMessage"),g=$(".login.page"),k=$(".chat.page"),r=$("#contextMenu"),l=$("#privateChannel"),t=$("#videoChannel"),z=$(".remoteVideo").get(0),J=$(".localVideo").get(0),C=$(".remoteAudio").get(0);$(".mute").bootstrapSwitch("state");$('[data-toggle="tooltip"]').tooltip();supportRTC()||$(".rtcAction").css("opacity",.5);i18n.init(function(n){function S(a){var b="",b=1===a.numUsers?b+n("there's 1 participant"):
b+(n("there are ")+a.numUsers+n(" participants"));m(b)}function P(a,b,d){b&&a?(G=b,y.emit("add user",{username:a,roomname:b,auth:d||I}),d&&(I=d)):(bootbox.alert(n("Error")+":"+n("Invalid user name or room name")),g.show())}function H(a,b){y.emit("new info",{toUser:a,msg:b})}function E(d){var c;c=d?b.val():a.val();(c=Common.cleanInput(c))&&W&&(d?(b.val(""),N({username:u||A,message:c,toUser:d}),y.emit("new message",{msg:c,toUser:d})):(a.val(""),N({username:u||A,message:c}),y.emit("new message",{msg:c})))}
function m(a,b){b=b||{};var d=$("<li>").addClass("log blinkOnAppearShort").text(a);"undefined"==typeof b.scrollToBottom&&(b.scrollToBottom=!0);b.color&&(d=d.css("color",b.color));Common.addElement(d,f,c,b)}function x(a,b){var d=n("file")+' "'+a+'" '+n("transfer completed in ")+b+n("s");m(d)}function v(){m(n("already sending receiving a file"))}function L(a,b,d){d=d||{};a=$('<li class="username userlist"/>').text(a).css("color",Common.getUsernameColor(a));d.scrollToBottom=!1;Common.addElement(a,b,
c,d)}function N(a,b){b=b||{};var d=h(a);0!==d.length&&(b.fade=!1,d.remove());d=$('<span class="messageType"/>');$('<span class="datetime"/>').text(Common.getTime());var e=$('<span class="username"/>').text(a.username).css("color",Common.getUsernameColor(a.username)),G=$('<span class="messageBody bubble"/>').html(Common.replaceNewLines(a.message));a.username===(u||A)?G.addClass("me"):G.addClass("you");var I=a.typing?"typing":"",I=$('<li class="message"/>').data("username",a.username).addClass(I);a.toUser&&
G.addClass("private");a.username===(u||A)?I.addClass("me").append(e,d,G):I.addClass("you").append(G,e,d);b.scrollToBottom=!0;Common.addElement(I,f,c,b);a.username===(u||A)||a.typing||(q.isCancelled=!1,Common.newMsgTitle(n("New messages"),q))}function V(a){a=a||{};a.scrollToBottom=!0;var b=$('<li class="message"/>'),d=$('<span class="log"/>').text(n("Current people in the room")+":");b.html(d);$("ul.users li").each(function(){var a=$('<span class="username"/>').text($(this).text()).css("color",Common.getUsernameColor($(this).text()));
b=b.append(a)});Common.addElement(b,f,c,a)}function K(a){h(a).fadeOut(function(){$(this).remove()})}function aa(){W&&(B||(B=!0,y.emit("typing")),Q=(new Date).getTime(),setTimeout(function(){2E3<=(new Date).getTime()-Q&&B&&(y.emit("stop typing"),B=!1)},2E3))}function h(a){return $(".typing.message").filter(function(b){return $(this).data("username")===a.username})}function X(d){(u||A)&&13===d.which&&(d.ctrlKey||d.metaKey||d.altKey||d.shiftKey?(d.preventDefault(),d.stopPropagation(),$(this).val(function(a,
b){return b+"\n"})):a.is(":focus")?(E(),y.emit("stop typing"),B=!1):b.is(":focus")&&E(l.data("toUser")))}function R(a){a.preventDefault();a.stopPropagation()}function Y(a){if(supportRTC()){var b=$(this).text();a.originalEvent.dataTransfer&&b!==u&&a.originalEvent.dataTransfer.files.length&&(a.preventDefault(),a.stopPropagation(),Z[b]=a.originalEvent.dataTransfer.files,m(n("initiating file transfer with ")+b),y.emit("start file request",{to:b}))}else a.preventDefault(),a.stopPropagation()}function p(a,
b){$(a).each(function(a,d){var c=n('Sending file "')+d.name+n('" to "')+b+n('". FileSize: ')+d.size;m(c);T.p2pOptions.to=b;T.p2pOptions.from=u||A;H(b,(u||A)+" =====>>> "+b+' : "'+d.name+'"');T.sendFile(d,x,v)})}function M(a){$(this).text()!==(u||A)&&(r.css({display:"block",left:a.pageX,top:a.pageY}),r.data("toUser",$(this).text()),r.i18n());return!1}$(".pages").i18n();var W=!1,B=!1,Q,U=n("TalkYet"),q={isCancelled:!1},u,G,A,I,ba=new Date("1970-01-01"),y=io.connect(Common.getBaseUrl(),{secure:!0}),
Z={};configs&&initConfigs(null);var T=new DataChannel(window.configs,window.constraints,y),F=new MediaChannel(window.configs,window.constraints,y);F.videoNode=z;F.myVideoNode=J;F.audioNode=C;T.onchannelopen=function(){console.log("channel onopen")};T.onchannelclose=function(a){console.log("channel onclose:"+a)};T.onchannelerror=function(a){console.error("channel error:"+a)};F.onVideoStreamopen=function(a){$(".videos").show();$(".stopVideo").show();$(".stopVideo").i18n();$(".mediaControls").show();
$(".callStatus").text("In Video Call");$(".callStatus").show();t.modal("show")};F.onVideoStreamclose=function(){$(".videoIcon").hide();$(".videos").hide();$(".stopVideo").hide();$(".mediaControls").hide();$(".callStatus").hide();t.modal("hide")};F.onAudioStreamopen=function(a){$(".audioIcon").show();$(".stopAudio").show();$(".mediaControls").show();$(".callStatus").text("In Audio Call");$(".callStatus").show()};F.onAudioStreamclose=function(){$(".audioIcon").hide();$(".stopAudio").hide();$(".mediaControls").hide();
$(".callStatus").hide()};$("#videoChannel").on("hidden.bs.modal",function(){F.inSession&&$(".videoIcon").show()});var D=Common.getCookie("username"),O=Common.getCookie("roomname"),w=null,ca=Common.getCookie("authInfo");0<ca.length&&(w=JSON.parse(ca));O&&""!==O&&e.val(O);0<D.length&&0<O.length&&"undefined"!==D&&w?P(D,O,w):g.show();y.emit("get ip");y.on("return ip",function(a){var b=a.split("."),d=(new Date).getTime()%60;if(!(4<b.length)){a="";for(var c=0;4>c;c++){var q=parseInt(b[c]).toString(16);
a+=q}}A="Guest_"+a+d});$("#enterRoomGuest").click(function(a){u=null;Common.deleteCookie("username");Common.deleteCookie("authInfo");P(A,Common.cleanInput(e.val().trim()))});$("#enterRoomFacebook").click(function(a){FB.login(function(a){"connected"===a.status?FB.api("/me",function(b){console.log("Successful login for: "+b.name);u=b.name;var d=a.authResponse;d.type="facebook";P(Common.cleanInput(b.name),Common.cleanInput(e.val().trim()),d)}):("not_authorized"===a.status&&bootbox.alert(n("Error")+":"+
n("Failed to login")),I=u=null)})});$(".roomnameInput").keydown(function(a){13===a.which&&P(u||A,Common.cleanInput(e.val().trim()))});c.keydown(function(a){r.hide()});a.keydown(X);b.keydown(X);a.on("input",function(){1<a.val().length&&aa()});a.click(function(){a.focus()});b.click(function(){b.focus()});y.on("disconnect",function(){window.location.reload()});y.on("logged in",function(b){W=!0;g.fadeOut();k.show();a.focus();u=b.username;G=b.roomname;supportRTC()||m(n("[Please use Chrome 29+ or Firefox 38+ for video/audio chats and file transfer]"),
{color:"orange"});var c=n("Welcome ")+b.username+n(" to Room ")+'"'+b.roomname+'"';m(c);S(b);b.users.forEach(function(a,b,c){L(a,d)});u&&"undefined"!==u&&""!==u&&Common.setCookie("username",u,1);G&&""!==G&&Common.setCookie("roomname",G,7);I&&u&&Common.setCookie("authInfo",JSON.stringify(I),1)});y.on("new message",function(a){N(a)});y.on("new info",function(a){m(a.message)});y.on("new poke",function(a){a=a.username+n(" has poked you!");m(a);alert(a)});y.on("user joined",function(a){m(a.username+n(" has joined"));
L(a.username,d)});y.on("user left",function(a){m(a.username+n(" has left"));K(a);$('.users > li:contains("'+a.username+'")').remove()});y.on("typing",function(a){a.typing=!0;a.message=n("is typing");N(a)});y.on("stop typing",function(a){K(a)});y.on("login error",function(a){bootbox.alert(n("Error")+":"+n(a.msg));u=I=null;g.show()});$("ul.users").on("contextmenu",".username",M);$("ul.users").on("click",".username",M);$("ul.users").on("dragover",".username",R);$("ul.users").on("dragenter",".username",
R);$("ul.users").on("drop",".username",Y);$("ul.messages").on("contextmenu",".username",M);$("ul.messages").on("click",".username",M);$("ul.messages").on("dragover",".username",R);$("ul.messages").on("drop",".username",Y);$("#sendMsg").click(function(a){a=r.data("toUser");l.data("toUser",a);l.find(".modal-title").text("To "+a);l.modal("toggle")});$("#startVideo").click(function(a){supportRTC()?(a=r.data("toUser"),m(n("initiating video connection with ")+a),y.emit("start video request",{to:a})):(a.preventDefault(),
a.stopPropagation())});$("#startAudio").click(function(a){supportRTC()?(a=r.data("toUser"),m(n("initiating audio connection with ")+a),y.emit("start audio request",{to:a})):(a.preventDefault(),a.stopPropagation())});$("#sendFile").click(function(a){a.preventDefault();a.stopPropagation();supportRTC()&&$("#fileInput").trigger("click")});$("#fileInput").change(function(a){var b=r.data("toUser");Z[b]=a.target.files;m(n("initiating file transfer with ")+b);y.emit("start file request",{to:b})});$(window).scroll(function(){Common.isScrolledToTop()?
$(".scrollArrow.upArrow").css("opacity",.5):$(".scrollArrow.upArrow").css("opacity",1);Common.isScrolledToBottom()?$(".scrollArrow.downArrow").css("opacity",.5):$(".scrollArrow.downArrow").css("opacity",1)});$(".scrollArrow.upArrow").click(function(){$("body,html").animate({scrollTop:0},500)});$(".scrollArrow.downArrow").click(function(){$("body,html").animate({scrollTop:$(".messages")[0].scrollHeight},500)});y.on("start video response",function(a){if(a&&a.to){var b=a.to;a.permitted?(H(b,(u||A)+n("has initiated a video chat")),
F.startVideo(b,u||A)):m(n("failed to start video with ")+b+". "+a.message)}});y.on("start audio response",function(a){if(a&&a.to){var b=a.to;a.permitted?(H(b,(u||A)+n("has initiated an audio chat")),F.startAudio(b,u||A)):m(n("failed to start audio with ")+b+". "+a.message)}});y.on("start file response",function(a){if(a&&a.to){var b=a.to;if(a.permitted){var d=Z[a.to];delete Z[a.to];p(d,b)}else m(n("failed to start file transfer with ")+b+". "+a.message)}});$("#poke").click(function(a){a=r.data("toUser");
5E3<Date.now()-ba?(m(n("You poked ")+a),y.emit("new poke",{toUser:a}),ba=Date.now()):bootbox.alert(n("Sorry, you are poking too fast!"))});$("#sendPrivateMsgBtn").click(function(a){E(l.data("toUser"))});l.on("shown.bs.modal",function(){b.focus()});$("body").on("click",function(){r.hide()});$("body").mouseover(function(){q.isCancelled=!0;$(document).prop("title",U)});$(".navbarItem").click(function(a){$(".navbar-toggle").is(":visible")&&$(".navbar-collapse").collapse("hide")});$("#listroommates").click(function(a){V()});
$("#about").click(function(a){bootbox.dialog({message:n("About Content"),title:n("About TalkYet"),onEscape:function(){},show:!0,buttons:{success:{label:"OK",className:"btn-success",callback:function(){}}}})});$("#quit").click(function(a){bootbox.confirm(n("Are you sure to quit?"),function(a){!0===a&&(Common.deleteCookie("username"),Common.deleteCookie("roomname"),Common.deleteCookie("authInfo"),window.location.reload(!0))})});$(".stopVideo").click(function(a){if(a=F.getPeer())H(a,(u||A)+n("has stopped video chat")),
F.stopVideo(),$(".mute").attr("checked",!0)});$(".stopAudio").click(function(a){if(a=F.getPeer())H(a,(u||A)+n("has stopped audio chat")),F.stopAudio(),$(".mute").attr("checked",!0)});$(".mute").on("switchChange.bootstrapSwitch",function(a,b){$(".mute").attr("checked",b);var d=F.getPeer();d&&(b?H(d,(u||A)+n("has unmuted their mic")):H(d,(u||A)+n("has muted their mic")),F.muteMe(b))});$(".remoteVideo").dblclick(function(a){document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement||
document.msFullscreenElement?document.exitFullscreen?document.exitFullscreen():document.msExitFullscreen?document.msExitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitExitFullscreen&&document.webkitExitFullscreen():z.requestFullscreen?z.requestFullscreen():z.mozRequestFullScreen?z.mozRequestFullScreen():z.webkitRequestFullscreen&&z.webkitRequestFullscreen()})})});var Common=function(){var c="#B51000 #74460C #C68600 #DE7D00 #235800 #206200 #659049 #257462 #2F6DBC #2D1D88 #7500B2 #9400A2".split(" "),e=function(c,d){var a=c.match(d);return a&&2==a.length?a[1]:null};return{util:{},addElement:function(c,d,a,b){c=$(c);b||(b={});"undefined"===typeof b.fade&&(b.fade=!0);"undefined"===typeof b.prepend&&(b.prepend=!1);b.fade&&c.hide().fadeIn(250);b.prepend?d.prepend(c):d.append(c);!0===b.scrollToBottom&&a.scrollTop(d[0].scrollHeight)},getTime:function(){var c=new Date;
return"["+"Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" ")[c.getMonth()]+"-"+c.getDate()+" "+c.getHours()+":"+c.getMinutes()+":"+c.getSeconds()+"] "},replaceNewLines:function(c){return c.replace(/\n/ig,"<br>")},cleanInput:function(c){return c.replace(/(<([^>]+)>)/ig,"").replace(/^([\r\n]+)/ig,"")},getBaseUrl:function(){var c=window.location;return c.protocol+"//"+c.host+"/"},newMsgTitle:function(c,d){d&&!d.isCancelled&&(document.title=c)},logError:function(c){console.log("error:"+JSON.stringify(c))},
logSuccess:function(c){console.log("success:"+c)},setOneWay:function(c){c=c.split("\r\n");for(var d=0;d<c.length;d++)c[d]=c[d].replace(/^a=sendrecv/i,"a=sendonly");return c=c.join("\r\n")},setTwoWay:function(c){c=c.split("\r\n");for(var d=0;d<c.length;d++)c[d]=c[d].replace(/^a=recvonly/i,"a=sendrecv");return c=c.join("\r\n")},preferOpus:function(c){c=c.split("\r\n");for(var d=0;d<c.length;d++)if(-1!==c[d].search("m=audio")){var a=d;break}if("undefined"!==typeof a){for(d=0;d<c.length;d++)if(-1!==c[d].search("opus/48000")){var b=
e(c[d],/:(\d+) opus\/48000/i);if(b){for(var d=c,g=a,k=c[a].split(" "),r=[],l=0,t=0;t<k.length;t++)3===l&&(r[l++]=b),k[t]!==b&&(r[l++]=k[t]);b=r.join(" ");d[g]=b}break}d=c[a].split(" ");for(g=c.length-1;0<=g;g--)if(b=e(c[g],/a=rtpmap:(\d+) CN\/\d+/i))b=d.indexOf(b),-1!==b&&d.splice(b,1),c.splice(g,1);c[a]=d.join(" ")}return c=c.join("\r\n")},setSDPBandwidth:function(c,d){for(var a=c.split("\r\n"),b=0;b<a.length;b++)a[b]=a[b].replace(/^b=AS:(\d)+/i,"b=AS:"+d);return c=a.join("\r\n")},saveToDisk:function(c,
d){var a=document.createElement("a");a.href=c;a.target="_blank";a.download=d||c;var b=document.createEvent("Event");b.initEvent("click",!0,!0);a.dispatchEvent(b);(window.URL||window.webkitURL).revokeObjectURL(a.href)},appendBuffer:function(c,d){var a=new Uint8Array(c.byteLength+d.byteLength);a.set(new Uint8Array(c),0);a.set(new Uint8Array(d),c.byteLength);return a.buffer},getCookie:function(c){c+="=";for(var d=document.cookie.split(";"),a=0;a<d.length;a++){for(var b=d[a];" "==b.charAt(0);)b=b.substring(1);
if(0==b.indexOf(c))return b.substring(c.length,b.length)}return""},setCookie:function(c,d,a){var b=new Date;b.setTime(b.getTime()+864E5*a);a="expires="+b.toUTCString();document.cookie=c+"="+d+"; "+a},deleteCookie:function(c){document.cookie=c+"=; expires=Thu, 01 Jan 1970 00:00:00 UTC"},isGuest:function(c){return!!c&&0===c.indexOf("Guest_")},getUsernameColor:function(e){for(var d=7,a=0;a<e.length;a++)d=e.charCodeAt(a)+(d<<5)-d;e=Math.abs(d%c.length);return c[e]},isScrolledToTop:function(){return 0===
$(window).scrollTop()},isScrolledToBottom:function(){return $(window).scrollTop()+$(window).height()==$(document).height()}}}();window.configs={iceServers:[]};window.contraints={optional:[]};window.moz=!!navigator.mozGetUserMedia;window.IsDataChannelSupported=!(moz&&!navigator.mozGetUserMedia||!moz&&!navigator.webkitGetUserMedia);window.isMobileDevice=navigator.userAgent.match(/Android|iPhone|iPad|iPod|BlackBerry|IEMobile/i);window.isChrome=!!navigator.webkitGetUserMedia;window.isFirefox=!!navigator.mozGetUserMedia;window.chromeVersion=isChrome?parseInt(navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)[2]):0;
...
l.push("jsonp="+f.jsonp)),l=l.join("&"),1<l.length&&(q+=-1<q.indexOf("?")?"&"+l:"?"+l),f.jsonp){var l=document.getElementsByTagName("head")[0],n=document.createElement("script");return n.type="text/javascript",n.src=q,l.appendChild(n),void 0}}b(function(b,d){if(b)return h(b);d.open(a,q,f.async);for(var c in k)k.hasOwnProperty(c)&&d.setRequestHeader(c,k[c]);d.onreadystatechange=function(){if(4===d.readyState){var a=d.responseText||"";h&&h(d.status,{text:function(){return a},json:function(){try{return JSON.parse(a)}catch(b){return p.error("Can not parse JSON. URL: "+
q),{}}}})}};d.send(g)})};({authBasic:function(a,b){var d=e.headers,c;c=a+":"+b;c=c.replace(/\r\n/g,"\n");for(var q="",u=0;u<c.length;u++){var f=c.charCodeAt(u);128>f?q+=String.fromCharCode(f):127<f&&2048>f?(q+=String.fromCharCode(192|f>>6),q+=String.fromCharCode(128|63&f)):(q+=String.fromCharCode(224|f>>12),q+=String.fromCharCode(128|63&f>>6),q+=String.fromCharCode(128|63&f))}c=q;var A,G,h,g="",k=0;do A=c.charCodeAt(k++),q=c.charCodeAt(k++),u=c.charCodeAt(k++),f=A>>2,A=(3&A)<<4|q>>4,G=(15&q)<<2|u>>
6,h=63&u,isNaN(q)?G=h=64:isNaN(u)&&(h=64),g+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(f)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(A)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(G)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(h);while(k<c.length);d.Authorization="Basic "+g},connect:function(a,b,d){return e("CONNECT",a,b,d)},del:function(a,b,d){return e("DELETE",a,b,d)},get:function(a,
...
p.regexEscape(h.interpolationSuffix);h.lng||(h.lng=p.detectLanguage());N=p.toLanguages(h.lng);E=N[0];p.log("currentLng set to: "+E);h.useCookie&&p.cookie.read(h.cookieName)!==E&&p.cookie.create(h.cookieName,E,h.cookieExpirationTime,h.cookieDomain);h.detectLngFromLocalStorage&&"undefined"!=typeof document&&window.localStorage&&p.localStorage.setItem("i18next_lng",E);var d=C;a.fixLng&&(d=function(a,b){return b=b||{},b.lng=b.lng||d.lng,C(a,b)},d.lng=E);B.setCurrentLng(E);m&&h.setJqueryExt&&r();var c;
if(m&&m.Deferred&&(c=m.Deferred()),!h.resStore){var e=p.toLanguages(h.lng);"string"==typeof h.preload&&(h.preload=[h.preload]);for(var f=0,g=h.preload.length;g>f;f++)for(var k=p.toLanguages(h.preload[f]),l=0,n=k.length;n>l;l++)0>e.indexOf(k[l])&&e.push(k[l]);return x.sync.load(e,h,function(a,q){v=q;V=!0;b&&b(d);c&&c.resolve(d)}),c?c.promise():void 0}return v=h.resStore,V=!0,b&&b(d),c&&c.resolve(d),c?c.promise():void 0}function b(a,b,d,c){"string"!=typeof b?(resource=b,b=h.ns.defaultNs):0>h.ns.namespaces.indexOf(b)&&
...
c.indexOf(g[k])&&c.push(g[k]);for(var n=[],e=0,f=c.length;f>e;e++){g=!1;if(k=v[c[e]])for(var l=0,m=a.length;m>l;l++)k[a[l]]||(g=!0);else g=!0;g&&n.push(c[e])}n.length?x.sync._fetch(n,d,function(d,c){var e=a.length*n.length;p.each(a,function(a,d){0>h.ns.namespaces.indexOf(d)&&h.ns.namespaces.push(d);p.each(n,function(a,q){v[q]=v[q]||{};v[q][d]=c[q][d];e--;0===e&&b&&(h.useLocalStorage&&x.sync._storeLocal(v),b())})})}):b&&b()}function k(b,d,c){return"function"==typeof d?(c=d,d={}):d||(d={}),d.lng=b,
a(d,c)}function r(){function a(b,d,c){if(0!==d.length){var q="text";0===d.indexOf("[")&&(q=d.split("]"),d=q[1],q=q[0].substr(1,q[0].length-1));d.indexOf(";")===d.length-1&&(d=d.substr(0,d.length-2));if("html"===q)c=h.defaultValueFromContent?m.extend({defaultValue:b.html()},c):c,b.html(m.t(d,c));else if("text"===q)c=h.defaultValueFromContent?m.extend({defaultValue:b.text()},c):c,b.text(m.t(d,c));else if("prepend"===q)c=h.defaultValueFromContent?m.extend({defaultValue:b.html()},c):c,b.prepend(m.t(d,
c));else if("append"===q)c=h.defaultValueFromContent?m.extend({defaultValue:b.html()},c):c,b.append(m.t(d,c));else if(0===q.indexOf("data-")){var e=q.substr(5);c=h.defaultValueFromContent?m.extend({defaultValue:b.data(e)},c):c;d=m.t(d,c);b.data(e,d);b.attr(q,d)}else c=h.defaultValueFromContent?m.extend({defaultValue:b.attr(q)},c):c,b.attr(q,m.t(d,c))}}function b(d,c){var e=d.attr(h.selectorAttr);if(e||"undefined"==typeof e||!1===e||(e=d.text()||d.val()),e){var f=d,u=d.data("i18n-target");(u&&(f=d.find(u)||
d),c||!0!==h.useDataAttrOptions||(c=d.data("i18n-options")),c=c||{},0<=e.indexOf(";"))?(e=e.split(";"),m.each(e,function(b,d){""!==d&&a(f,d,c)})):a(f,e,c);!0===h.useDataAttrOptions&&d.data("i18n-options",c)}}m.t=m.t||C;m.fn.i18n=function(a){return this.each(function(){b(m(this),a);m(this).find("["+h.selectorAttr+"]").each(function(){b(m(this),a)})})}}function l(a,b,d,c){if(!a||(c=c||b,0>a.indexOf(c.interpolationPrefix||h.interpolationPrefix)))return a;var e=c.interpolationPrefix?p.regexEscape(c.interpolationPrefix):
h.interpolationPrefixEscaped,f=c.interpolationSuffix?p.regexEscape(c.interpolationSuffix):h.interpolationSuffixEscaped,g="HTML"+f;return p.each(b.replace&&"object"==typeof b.replace?b.replace:b,function(b,u){var k=d?d+h.keyseparator+b:b;"object"==typeof u&&null!==u?a=l(a,u,k,c):c.escapeInterpolation||h.escapeInterpolation?(a=a.replace(new RegExp([e,k,g].join(""),"g"),p.regexReplacementEscape(u)),a=a.replace(new RegExp([e,k,f].join(""),"g"),p.regexReplacementEscape(p.escape(u)))):a=a.replace(new RegExp([e,
k,f].join(""),"g"),p.regexReplacementEscape(u))}),a}function t(a,b){var d=p.extend({},b);for(delete d.postProcess;-1!=a.indexOf(h.reusePrefix)&&(L++,!(L>h.maxRecursion));){var c=a.lastIndexOf(h.reusePrefix),e=a.indexOf(h.reuseSuffix,c)+h.reuseSuffix.length,f=a.substring(c,e),g=f.replace(h.reusePrefix,"").replace(h.reuseSuffix,"");if(c>=e)return p.error("there is an missing closing in following translation value",a),"";if(-1!=g.indexOf(",")&&(c=g.indexOf(","),-1!=g.indexOf("{",c)&&-1!=g.indexOf("}",
c))){var e=g.indexOf("{",c),k=g.indexOf("}",e)+1;try{d=p.extend(d,JSON.parse(g.substring(e,k))),g=g.substring(0,c)}catch(l){}}g=P(g,d);a=a.replace(f,p.regexReplacementEscape(g))}return a}function z(a){return void 0!==a.count&&"string"!=typeof a.count}function J(a,b){b=b||{};var d=n(a,b),c=H(a,b);return void 0!==c||c===d}function C(a,b){return b=b||{},V?(L=0,P.apply(null,arguments)):(p.log("i18next not finished initialization. you might have called t function before loading resources finished."),b.defaultValue||
"")}function n(a,b){return void 0!==b.defaultValue?b.defaultValue:a}function S(){for(var a=[],b=1;b<arguments.length;b++)a.push(arguments[b]);return{postProcess:"sprintf",sprintf:a}}function P(a,b){if(b&&"object"!=typeof b?"sprintf"===h.shortcutFunction?b=S.apply(null,arguments):"defaultValue"===h.shortcutFunction&&(b={defaultValue:b}):b=b||{},"object"==typeof h.defaultVariables&&(b=p.extend({},h.defaultVariables,b)),void 0===a||null===a||""===a)return"";"string"==typeof a&&(a=[a]);var d=a[0];if(1<
a.length)for(var c=0;c<a.length&&(d=a[c],!J(d,b));c++);var e,c=n(d,b),f=H(d,b),g=b.lng?p.toLanguages(b.lng,b.fallbackLng):N,k=b.ns||h.ns.defaultNs;-1<d.indexOf(h.nsseparator)&&(e=d.split(h.nsseparator),k=e[0],d=e[1]);void 0===f&&h.sendMissing&&"function"==typeof h.missingKeyHandler&&(b.lng?h.missingKeyHandler(g[0],k,d,c,g):h.missingKeyHandler(h.lng,k,d,c,g));g=b.postProcess||h.postProcess;void 0!==f&&g&&Q[g]&&(f=Q[g](f,d,b));k=c;if(-1<c.indexOf(h.nsseparator)&&(e=c.split(h.nsseparator),k=e[1]),k===
d&&h.parseMissingKey&&(c=h.parseMissingKey(c)),void 0===f&&(c=l(c,b),c=t(c,b),g&&Q[g]))e=n(d,b),f=Q[g](e,d,b);return void 0!==f?f:c}function H(a,b){b=b||{};var d,c,e=n(a,b),f=N;if(!v||"cimode"===f[0].toLowerCase())return e;if(b.lngs&&(f=b.lngs),b.lng&&(f=p.toLanguages(b.lng,b.fallbackLng),!v[f[0]])){var g=h.getAsync;h.getAsync=!1;x.sync.load(f,h,function(a,b){p.extend(v,b);h.getAsync=g})}var k=b.ns||h.ns.defaultNs;-1<a.indexOf(h.nsseparator)&&(d=a.split(h.nsseparator),k=d[0],a=d[1]);if(b.context&&
("string"==typeof b.context||"number"==typeof b.context)&&(d=p.extend({},b),delete d.context,d.defaultValue=h.contextNotFound,c=C(k+h.nsseparator+a+"_"+b.context,d),c!=h.contextNotFound))return l(c,{context:b.context});if(z(b,f[0])){d=p.extend({lngs:[f[0]]},b);delete d.count;delete d.lng;d.defaultValue=h.pluralNotFound;var m;if(B.needsPlural(f[0],b.count)){m=k+h.nsseparator+a+h.pluralSuffix;var r=B.get(f[0],b.count);0<=r?m=m+"_"+r:1===r&&(m=k+h.nsseparator+a)}else m=k+h.nsseparator+a;if(c=C(m,d),
c!=h.pluralNotFound)return l(c,{count:b.count,interpolationPrefix:b.interpolationPrefix,interpolationSuffix:b.interpolationSuffix});if(!(1<f.length))return c;d=f.slice();if(d.shift(),b=p.extend(b,{lngs:d}),delete b.lng,c=C(k+h.nsseparator+a,b),c!=h.pluralNotFound)return c}if(void 0!==b.indefinite_article&&"string"!=typeof b.indefinite_article&&b.indefinite_article&&(d=p.extend({},b),delete d.indefinite_article,d.defaultValue=h.indefiniteNotFound,m=k+h.nsseparator+a+(b.count&&!z(b,f[0])||!b.count?
h.indefiniteSuffix:""),c=C(m,d),c!=h.indefiniteNotFound))return c;var D;c=a.split(h.keyseparator);d=0;for(m=f.length;m>d&&void 0===D;d++){for(var r=f[d],O=0,w=v[r]&&v[r][k];c[O];)w=w&&w[c[O]],O++;if(void 0!==w){D=Object.prototype.toString.apply(w);if("string"==typeof w)w=l(w,b),w=t(w,b);else if("[object Array]"!==D||h.returnObjectTrees||b.returnObjectTrees)if(null===w&&!0===h.fallbackOnNull)w=void 0;else{if(null!==w)if(h.returnObjectTrees||b.returnObjectTrees){if("[object Number]"!==D&&"[object Function]"!==
D&&"[object RegExp]"!==D){var E="[object Array]"===D?[]:{};p.each(w,function(d){E[d]=P(k+h.nsseparator+a+h.keyseparator+d,b)});w=E}}else h.objectTreeKeyHandler&&"function"==typeof h.objectTreeKeyHandler?w=h.objectTreeKeyHandler(a,w,r,k,b):(w="key '"+k+":"+a+" ("+r+")' returned an object instead of string.",p.log(w))}else w=w.join("\n"),w=l(w,b),w=t(w,b);"string"==typeof w&&""===w.trim()&&!0===h.fallbackOnEmpty&&(w=void 0);D=w}}if(void 0===D&&!b.isFallbackLookup&&(!0===h.fallbackToDefaultNS||h.fallbackNS&&
0<h.fallbackNS.length)){if(b.isFallbackLookup=!0,h.fallbackNS.length)for(f=0,c=h.fallbackNS.length;c>f;f++){if(D=H(h.fallbackNS[f]+h.nsseparator+a,b),D||""===D&&!1===h.fallbackOnEmpty)if(d=-1<D.indexOf(h.nsseparator)?D.split(h.nsseparator)[1]:D,m=-1<e.indexOf(h.nsseparator)?e.split(h.nsseparator)[1]:e,d!==m)break}else D=H(a,b);b.isFallbackLookup=!1}return D}Array.prototype.indexOf||(Array.prototype.indexOf=function(a){if(null==this)throw new TypeError;var b=Object(this),d=b.length>>>0;if(0===d)return-1;
...
for(d=0<=c?Math.min(c,d-1):d-Math.abs(c);0<=d;d--)if(d in b&&b[d]===a)return d;return-1});"function"!=typeof String.prototype.trim&&(String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")});var E,m=this.jQuery||this.Zepto,x={},v={},L=0,N=[],V=!1,K={};if("undefined"!=typeof module&&module.exports){if(!m)try{m=require("jquery")}catch(aa){}m&&(m.i18n=m.i18n||x);module.exports=x}else m&&(m.i18n=m.i18n||x),this.i18n=this.i18n||x;var K={load:function(a,b,d){b.useLocalStorage?K._loadLocal(a,
b,function(c,e){for(var f=[],g=0,h=a.length;h>g;g++)e[a[g]]||f.push(a[g]);0<f.length?K._fetch(f,b,function(a,b){p.extend(e,b);K._storeLocal(b);d(null,e)}):d(null,e)}):K._fetch(a,b,function(a,b){d(null,b)})},_loadLocal:function(a,b,d){var c={},e=(new Date).getTime();if(window.localStorage){var f=a.length;p.each(a,function(a,q){var g=window.localStorage.getItem("res_"+q);g&&(g=JSON.parse(g),g.i18nStamp&&g.i18nStamp+b.localStorageExpirationTime>e&&(c[q]=g));f--;0===f&&d(null,c)})}},_storeLocal:function(a){if(window.localStorage)for(var b in a)a[b].i18nStamp=
...
objectTreeKeyHandler:void 0,postProcess:void 0,parseMissingKey:void 0,missingKeyHandler:K.postMissing,shortcutFunction:"sprintf"},X={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;","/":"&#x2F;"},R={create:function(a,b,d,c){if(d){var e=new Date;e.setTime(e.getTime()+6E4*d);d="; expires="+e.toGMTString()}else d="";document.cookie=a+"="+b+d+";"+(c?"domain="+c+";":"")+"path=/"},read:function(a){a+="=";for(var b=document.cookie.split(";"),d=0;d<b.length;d++){for(var c=b[d];" "==c.charAt(0);)c=
c.substring(1,c.length);if(0===c.indexOf(a))return c.substring(a.length,c.length)}return null},remove:function(a){this.create(a,"",-1)}},Y={create:function(){},read:function(){return null},remove:function(){}},p={extend:m?m.extend:c,deepExtend:e,each:m?m.each:f,ajax:m?m.ajax:"undefined"!=typeof document?d:function(){},cookie:"undefined"!=typeof document?R:Y,detectLanguage:function(){var a,b=h.lngWhitelist||[],d=[];if("undefined"!=typeof window&&!function(){for(var a=window.location.search.substring(1).split("&"),
...
navigator.language&&d.push(navigator.language)}return function(){for(var c=0;c<d.length;c++){var e=d[c];-1<e.indexOf("-")&&(e=e.split("-"),e=h.lowerCaseLng?e[0].toLowerCase()+"-"+e[1].toLowerCase():e[0].toLowerCase()+"-"+e[1].toUpperCase());if(0===b.length||-1<b.indexOf(e)){a=e;break}}}(),a||(a=h.fallbackLng[0]),a},escape:function(a){return"string"==typeof a?a.replace(/[&<>"'\/]/g,function(a){return X[a]}):a},log:function(a){h.debug&&"undefined"!=typeof console&&console.log(a)},error:function(a){"undefined"!=
...
0:1)},18:function(a){return Number(1==a?1:2)},19:function(a){return Number(1==a?0:0===a||1<a%100&&11>a%100?1:10<a%100&&20>a%100?2:3)},20:function(a){return Number(1==a?0:0===a||0<a%100&&20>a%100?1:2)},21:function(a){return Number(1==a%100?1:2==a%100?2:3==a%100||4==a%100?3:0)}},B={rules:function(){var a,b={};for(a=M.length;a--;)b[M[a][0]]={name:M[a][1],numbers:M[a][2],plurals:W[M[a][3]]};return b}(),addRule:function(a,b){B.rules[a]=b},setCurrentLng:function(a){if(!B.currentRule||B.currentRule.lng!==
a){var b=a.split("-");B.currentRule={lng:a,rule:B.rules[b[0]]}}},needsPlural:function(a,b){var d,c=a.split("-");return d=B.currentRule&&B.currentRule.lng===a?B.currentRule.rule:B.rules[c[p.getCountyIndexOfLng(a)]],d&&1>=d.numbers.length?!1:1!==this.get(a,b)},get:function(a,b){var d;d=a.split("-")[p.getCountyIndexOfLng(a)];if(d=B.currentRule&&B.currentRule.lng===a?B.currentRule.rule:B.rules[d]){var c;c=d.noAbs?d.plurals(b):d.plurals(Math.abs(b));c=d.numbers[c];d=(2===d.numbers.length&&1===d.numbers[0]&&
(2===c?c=-1:1===c&&(c=1)),c)}else d=1===b?"1":"-1";return d}},Q={},R=function(a,b){Q[a]=b},U=function(){function a(b){return Object.prototype.toString.call(b).slice(8,-1).toLowerCase()}var b=function(){return b.cache.hasOwnProperty(arguments[0])||(b.cache[arguments[0]]=b.parse(arguments[0])),b.format.call(null,b.cache[arguments[0]],arguments)};return b.format=function(b,d){var c,e,f,g,h,k=1,l=b.length,u="",m=[];for(e=0;l>e;e++)if(u=a(b[e]),"string"===u)m.push(b[e]);else if("array"===u){if(g=b[e],
g[2])for(c=d[k],f=0;f<g[2].length;f++){if(!c.hasOwnProperty(g[2][f]))throw U('[sprintf] property "%s" does not exist',g[2][f]);c=c[g[2][f]]}else c=g[1]?d[g[1]]:d[k++];if(/[^s]/.test(g[8])&&"number"!=a(c))throw U("[sprintf] expecting number but found %s",a(c));switch(g[8]){case "b":c=c.toString(2);break;case "c":c=String.fromCharCode(c);break;case "d":c=parseInt(c,10);break;case "e":c=g[7]?c.toExponential(g[7]):c.toExponential();break;case "f":c=g[7]?parseFloat(c).toFixed(g[7]):parseFloat(c);break;
case "o":c=c.toString(8);break;case "s":c=(c=String(c))&&g[7]?c.substring(0,g[7]):c;break;case "u":c=Math.abs(c);break;case "x":c=c.toString(16);break;case "X":c=c.toString(16).toUpperCase()}c=/[def]/.test(g[8])&&g[3]&&0<=c?"+"+c:c;f=g[4]?"0"==g[4]?"0":g[4].charAt(1):" ";h=g[6]-String(c).length;if(g[6]){for(var n=[];0<h;n[--h]=f);f=n.join("")}else f="";m.push(g[5]?c+f:f+c)}return m.join("")},b.cache={},b.parse=function(a){for(var b=[],d=[],c=0;a;){if(null!==(b=/^[^\x25]+/.exec(a)))d.push(b[0]);else if(null!==
...
d.push(b)}a=a.substring(b[0].length)}return d},b}();R("sprintf",function(a,b,c){c.sprintf&&("[object Array]"===Object.prototype.toString.apply(c.sprintf)?(b=c.sprintf,a=(b.unshift(a),U.apply(null,b))):a="object"==typeof c.sprintf?U(a,c.sprintf):a);return a});x.init=a;x.setLng=k;x.preload=function(b,c){"string"==typeof b&&(b=[b]);for(var d=0,e=b.length;e>d;d++)0>h.preload.indexOf(b[d])&&h.preload.push(b[d]);return a(c)};x.addResourceBundle=function(a,b,c,d){"string"!=typeof b?(c=b,b=h.ns.defaultNs):
0>h.ns.namespaces.indexOf(b)&&h.ns.namespaces.push(b);v[a]=v[a]||{};v[a][b]=v[a][b]||{};d?p.deepExtend(v[a][b],c):p.extend(v[a][b],c)};x.hasResourceBundle=function(a,b){"string"!=typeof b&&(b=h.ns.defaultNs);v[a]=v[a]||{};var c=v[a][b]||{},d=!1,e;for(e in c)c.hasOwnProperty(e)&&(d=!0);return d};x.addResource=b;x.addResources=function(a,c,d){"string"!=typeof c?(resource=c,c=h.ns.defaultNs):0>h.ns.namespaces.indexOf(c)&&h.ns.namespaces.push(c);for(var e in d)"string"==typeof d[e]&&b(a,c,e,d[e])};x.removeResourceBundle=
function(a,b){"string"!=typeof b&&(b=h.ns.defaultNs);v[a]=v[a]||{};v[a][b]={}};x.loadNamespace=function(a,b){g([a],b)};x.loadNamespaces=g;x.setDefaultNamespace=function(a){h.ns.defaultNs=a};x.t=C;x.translate=C;x.exists=J;x.detectLanguage=p.detectLanguage;x.pluralExtensions=B;x.sync=K;x.functions=p;x.lng=function(){return E};x.addPostProcessor=R;x.options=h}();var MediaChannel=function(c,e,f){this.configs=c;this.contraints=e;this.signalingChannel=new SignalingChannel(f,"media",this);this.p2pOptions={audio:!1,video:!1,isCaller:!1};this.pc;this.inSession=!1;this.localStream;this.remoteStream;this.videoNode;this.myVideoNode;this.audioNode;this.inSession=!1;this.onVideoStreamopen;this.onVideoStreamclose;this.onAudioStreamopen;this.onAudioStreamclose;this.createSrc=window.URL?window.URL.createObjectURL:function(c){return c};this.localDescCreated=function(c){c.sdp=
